...
const REGISTRY = {
  ...
  'compositions':    { src: 'assets/js/compositions.js?v=7',    expose: 'PIACompositions' },
  'budget':          { src: 'assets/js/budget.js?v=5',          deps: ['excel-export'], expose: 'PIABudget' },
  'orcamento':       { src: 'assets/js/orcamento.js?v=17',        deps: ['excel-export'], expose: 'PIAOrcamento' },
  ...
  'quotations':      { src: 'assets/js/quotations.js?v=11',      deps: ['excel-export'], expose: 'PIAQuotations' },
  'suppliers':       { src: 'assets/js/suppliers.js?v=5',       expose: 'PIASuppliers' },
  'materials-catalog':{ src: 'assets/js/materials-catalog.js?v=7', expose: 'PIAMaterialsCatalog' },
  'discipline-ai':   { src: 'assets/js/discipline-ai-modal.js?v=25' },
  'pcp':             { src: 'assets/js/pcp.js?v=7',             deps: ['pia-shell','excel-export'], expose: 'PIAPCP' },
  'planner-hub':     { src: 'assets/js/planner-hub.js?v=2',     deps: ['pia-shell'], expose: 'PIAPlannerHub' },
  'tdraw':           { src: 'assets/js/tdraw.js?v=13',           deps: ['pia-shell','excel-export'], expose: 'PIATDraw' },
  'eng-modules':     { src: 'assets/js/eng-modules.js?v=4',     deps: ['pia-shell','excel-export'], expose: 'PIAEngModule' },
