...
const REGISTRY = {
  ...
  'budget':          { src: 'assets/js/budget.js?v=6',          deps: ['excel-export'], libs: ['xlsx','chart','jspdf'], expose: 'PIABudget' },
  ...
  'ai-quotation':    { src: 'assets/js/ai-quotation.js?v=2',    deps: ['ai-router'], expose: 'PIAIAQuotation' },
  'ai-supplier':     { src: 'assets/js/ai-supplier.js?v=2',     deps: ['ai-router'], expose: 'PIAIASupplier' },
  ...
  'discipline-ai':   { src: 'assets/js/discipline-ai-modal.js?v=27', libs: ['xlsx'] },
